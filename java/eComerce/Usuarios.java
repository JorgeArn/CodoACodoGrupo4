...
public class Usuarios {
    ...
    private int fechaDeNacimiento; // Falta poner el tipo
    private String pais;

    // Constructores
    public Usuarios(Integer id, String nombre, String apellido, String email, String clave, int fechaDeNacimiento,
            String pais) {
        this.id = id;
        this.nombre = nombre;
